      ...
      <div class="modal fade" id="canselModal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
          <div id="trip" class="modal-content">
            ...
            <div class="modal-footer justify-content-center">
              <form method="POST" id="cancelform" action="{{ route('cancel_package_trip') }}">
                @csrf
      ...
      success: function(response) {
        ...
        $.each(data, function(index) {
          ...
          if (data[index].trip_status == 'ended') {
            ...
            st += "<p style='text-align: center;'>your trip has ended</p>";
            ...
            st += " <p>Vehicle color:  <span style='height: 25px; width: 25px;background-color:" + data[index].color + " ;  display: inline-block;'> </span> <br></p>";
            st += " <p>Vehicle brand:" + data[index].brand + "<br></p>";
            st += "</div>";
            st += " <div  class='col-md-6 col-sm-6'>";
            st += " <p>Vehicle model:" + data[index].model + "<br></p>";
            st += " <p>Vehicle license number: " + data[index].license_num + "<br></p>";
            st += " <p>Trip Cost:" + data[index].trip_cost + "<br></p>";
