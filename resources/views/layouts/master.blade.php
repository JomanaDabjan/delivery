...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center header-transparent">
    <div class="container d-flex justify-content-between align-items-center">
      ...
      <div class="logo">
        <h1 class="text-light"><a href="index.html"><img src="/assets/img/logo_transperent.png" data-aos="fade-right" alt="" class="img-fluid"><span>RideShare</span></a></h1>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="btn-account" href="signup.html">Signup</a> </li>
          <li><a class="btn-account" href="login.html">Login</a></li>
        </ul>
