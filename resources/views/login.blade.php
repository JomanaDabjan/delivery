        ...
        <div class="container" >
          <form class="form needs-validation" novalidate>
            <div class="form-group">
              ...
              <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email"  pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" required title="someemail@mail.something">
            ...
            <div class="form-group">
              ...
              <input type="password" class="form-control" id="exampleInputPassword1" placeholder="Password" pattern=".{6,}" required title="Password should have at least 6 or more characters">
              <div class="invalid-feedback">
                Please provide a valid password.
              </div>
            </div>
            <div class=" d-flex justify-content-center" ><button type="submit" class="btn-log btn  ">Login</button></div>
